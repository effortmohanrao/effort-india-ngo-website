export type Project = {
  ...
  funder: string;
  category: string;
  // R2 key under website/programs/{completed|ongoing}/{photoFolder}/ — only set when
  // real photographs exist for this project. Left unset means an honest "no photos yet"
  // state on the site, never a stock/placeholder image.
  photoFolder?: string;
};
...
export const completedProjects: Project[] = [
  ...
  { name: "Promotion of Farmers Associations", beneficiaries: "Small & marginal farmers in 152 villages, covering 2,000 farmers", funder: "NABARD", category: AGRI, photoFolder: "nabard-programs" },
  ...
  { name: "Andhra Pradesh Community Health Intervention Project", beneficiaries: "12 villages covering 65,000 population, aimed at reducing incidence of TB, HIV/AIDS, Malaria, Filaria and Leprosy", funder: "DFID through RISE", category: HEALTH, photoFolder: "apchip" },
  { name: "Conservation of Natural Resources for Promotion of Livelihoods through Watershed Approach", beneficiaries: "272 families in Jaganadhapuram", funder: "Millepede Foundation", category: NRM, photoFolder: "millepede-watershed" },
  { name: "Pilot Project on SRI Paddy", beneficiaries: "400 farmers educated across 16 villages, covering 400 acres of demo plots", funder: "NABARD", category: AGRI, photoFolder: "nabard-sri-paddy" },
  ...
  { name: "Watershed Development Fund Projects Addressing Farmer Distress", beneficiaries: "90 watershed projects covering 3 districts of AP, with EFFORT acting as RSO", funder: "NABARD", category: AGRI, photoFolder: "nabard-watershed-dev-fund" },
  { name: "Swagati HIV/AIDS Interventions Project", beneficiaries: "8 mandals of Markapur revenue division, covering 1,020 female sex workers", funder: "APSACS", category: HEALTH, photoFolder: "apsacs-hiv-aids" },
  { name: "Umbrella Programme for Natural Resource Management", beneficiaries: "Sustainable livelihoods for rural poor dependent on natural resources across 13 villages, covering 500 families", funder: "NABARD", category: NRM, photoFolder: "nabard-umbrella-nrm" },
  ...
  { name: "Tribal Development Fund Project", beneficiaries: "Sustainable livelihoods for 1,000 tribal families through Horticulture crops via the Wadi approach", funder: "NABARD", category: AGRI, photoFolder: "nabard-tribal-dev-fund" },
  ...
  { name: "Improving Crop Productivity of Mustard through Bee Pollination", beneficiaries: "Improving crop productivity for 15,000 farmers across 4 states of India through beekeeping", funder: "Corteva Agriscience", category: AGRI, photoFolder: "mustard-bee-pollination" },
  ...
  { name: "Honeybee Project in Mustard Cultivation", beneficiaries: "Supporting 5,000 mustard-cultivating farmers to improve yield", funder: "PHI Seeds India Limited", category: AGRI, photoFolder: "mustard-bee-pollination" },
...
export const ongoingProjects: Project[] = [
  { name: "Promotion & Strengthening of Farmers Producer Organisations", beneficiaries: "Sensitising and organising small & marginal farmers to address farmer-related issues across 150 villages", funder: "NABARD, under CSS and PODF", category: AGRI, photoFolder: "fpo-promotion-nabard" },
  { name: "Promotion of Bio-diversity Conservation Park and Water Harvesting Structures", beneficiaries: "Creating biodiversity parks to boost ecosystems and promote soil, water and native flora conservation", funder: "Godfrey Phillips India Ltd", category: NRM, photoFolder: "biodiversity-water-gpi" },
  { name: "Climate Resilient Farming Project for Organic Orchards", beneficiaries: "sustained improvement of living conditions for small-scale farmers and producers through climate-resilient organic orchard management, agro-ecological practices, food security, and self-reliance across Tamil Nadu, Kerala and Karnataka", funder: "Fairtrade International", category: AGRI },
  { name: "Integrated Climate-Resilient Farming Systems for Sustainable Livelihoods and Water Conservation", beneficiaries: "Improving livelihoods of 1,904 small & marginal farmers and 1,435 landless agricultural labourers across 24 marginalised villages of Prakasam district through climate-resilient farming and resource conservation", funder: "Azim Premji Foundation", category: AGRI, photoFolder: "azim-premji-climate-resilient" },
  ...
  { name: "Improving Self-Reliance and Resilience of Rural Communities in Prakasam District", beneficiaries: "Building resilient communities with the strength to overcome social, educational, health, environmental and economic hardships", funder: "Reliance Foundation", category: AGRI, photoFolder: "reliance-foundation" },
  ...
  { name: "Promotion of Climate Resilient Farming through Effective Natural Resource Management", beneficiaries: "Climate-resilient agro-ecological approaches across 5 villages of Aluru Mandal, Kurnool district, covering 250 small & marginal farmers", funder: "DKA Austria", category: NRM, photoFolder: "dka-nrm-kurnool" },
  { name: "Strengthening Amenities in Government Schools", beneficiaries: "Providing amenities and infrastructure in government schools to ensure 100% school education", funder: "Prakasam Global NRI Forum", category: CHILD_ONGOING, photoFolder: "prakasam-nri-schools" },
  { name: "Integrated Agri Extension Project in Chilli Value Chain", beneficiaries: "Increasing farming incomes through better price discovery and stabilised yields of red chillies via GAP adoption across select regions of South India", funder: "IDH, Netherlands", category: AGRI, photoFolder: "chilli-value-chain-idh" },
  { name: "Water Governance and Management Project", beneficiaries: "Developing 'Water Plus Villages' ensuring water security, ecological restoration and biodiversity protection", funder: "JSW Foundation", category: NRM, photoFolder: "jsw-water-governance" },
  ...
  { name: "Carbon Sequestration Project", beneficiaries: "Reducing carbon through horticulture and timber species across 500 acres, promoting carbon credits", funder: "VARAHA", category: NRM, photoFolder: "varaha-carbon-sequestration" },
];
