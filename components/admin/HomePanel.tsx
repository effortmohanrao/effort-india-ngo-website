...
const sections: Section[] = [
  { icon: Sparkles, title: "Hero", desc: "Headline, subtext, call-to-action buttons, and the credibility strip." },
    ...
    <div className="p-6">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
        {sections.map((section) => (
          <div
            key={section.title}
            className="rounded-2xl border border-slate-200 bg-white p-4 flex flex-col gap-2.5 hover:border-emerald-300 hover:shadow-sm transition-all"
          >
